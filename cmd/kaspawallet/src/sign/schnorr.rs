...
//!   message; the cross-wallet sign-flow AC's operative
//!   property is signature VALIDITY under the cosigner's
//!   derived x-only pubkey on the canonical sighash, not
//!   byte-equality of signature bytes.
